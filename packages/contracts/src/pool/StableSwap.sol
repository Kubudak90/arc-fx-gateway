...
/**
 * @title StableSwap - A StableSwap implementation in Solidity.
 ...
 * SafeMath removed — 0.8 has built-in overflow checks.
 */
contract StableSwap is Ownable, Pausable, ReentrancyGuard {
    ...
    // events replicated from SwapUtils to make the ABI easier for dumb clients
    event TokenSwap(
    ...
    /**
     * @notice Initializes this StableSwap contract with the given parameters.
     * This will also deploy a new LPToken contract that represents users' LP positions.
     * The owner of LPToken will be this contract.
     *
    ...
    constructor(
        ...
        for (uint8 i = 0; i < _pooledTokens.length; i++) {
            ...
            precisionMultipliers[i] =
                10 **
                    uint256(
                        SwapUtils.POOL_PRECISION_DECIMALS - decimals[i]
                    );
     ...
     * withdrawals, excluding fees but including slippage.
     *
    ...
    /**
     * @notice Pause the pool. Only callable by owner.
     */
    ...
    /**
     * @notice Unpause the pool. Only callable by owner.
     */
